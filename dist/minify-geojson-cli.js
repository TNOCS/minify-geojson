...
var CommandLineInterface = (function () {
    ...
    CommandLineInterface.optionDefinitions = [
        ...
        },
        {
            ...
            type: String,
            typeLabel: 'String',
            description: 'Comma separted list of property filters, which will KEEP those features when the property filter returns true, e.g. filter "WATER = NO" will filter out feature\'s where "WATER": "NO".',
        },
        {
            name: 'blacklist',
            alias: 'b',
            type: String,
            typeLabel: 'String',
            description: 'Comma separated list of properties that should be removed (others will be kept). Note that keys will not be minified unless the -k flag is used too.',
        },
        {
            name: 'whitelist',
            alias: 'w',
            type: String,
            typeLabel: 'String',
            description: 'Comma separated list of properties that should be kept (others will be removed). Note that keys will not be minified unless the -k flag is used too.',
        },
        {
            name: 'coordinates',
            alias: 'c',
...
var minifyGeoJSON = options.topo || options.reproject ? new minify_geojson_1.MinifyGeoJSON(options) : new minify_geojson_streaming_1.MinifyGeoJSONStreaming(options);
